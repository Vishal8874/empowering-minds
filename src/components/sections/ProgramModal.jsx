...
export default function ProgramModal({ program, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-[var(--color-primary)]/60 px-3 py-4 sm:px-4 sm:py-8">
      <div className="relative max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-[24px] bg-white p-5 shadow-2xl sm:rounded-[32px] sm:p-8">
        <button
          type="button"
          onClick={onClose}
        ...
        <h3 className="mt-3 pr-10 text-2xl font-black tracking-tight text-[var(--color-primary)] sm:text-3xl">
          {program.title}
        </h3>
